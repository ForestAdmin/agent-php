...
dataset('datasourceWithOnetoOneAndManyToOne', function () {
...
})->with('datasourceWithOnetoOneAndManyToOne');



test('all() should return all the collection fields without the relations', function ($datasource) {
    $collection = $datasource->getCollection('books');
