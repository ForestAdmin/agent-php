...
test('of() should return a ForestAdmin\\AgentPHP\\Agent\\Utils\\QueryAggregate instance', function () {
    ...
    $query = QueryAggregate::of($bookCollection, QueryConverter::of($bookCollection, 'Europe/Paris'), new Aggregation('Count'));
...
test('get() should work with grouped aggregation', function () {
    ...
    $query = QueryAggregate::of($bookCollection, QueryConverter::of($bookCollection, 'Europe/Paris'), $aggregation);
